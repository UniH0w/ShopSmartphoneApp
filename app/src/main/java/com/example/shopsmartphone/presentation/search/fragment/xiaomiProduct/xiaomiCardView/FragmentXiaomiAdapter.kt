...
class FragmentXiaomiAdapter: RecyclerView.Adapter<XiaomiViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): XiaomiViewHolder {
        return XiaomiViewHolder(
    ...
    override fun onBindViewHolder(holder: XiaomiViewHolder, position: Int) {
