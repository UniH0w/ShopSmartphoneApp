...
import com.example.shopsmartphone.databinding.FragmentHuaweiBinding
...
class FragmentHuawei: BaseFragment() {
    ...
    lateinit var binding: FragmentHuaweiBinding
    lateinit var adapter: FragmentHuaweiAdapter
    ...
    override fun onCreateView(
        ...
        binding.imageButton2.setOnClickListener {
            findNavController()
                .navigate(R.id.action_fragmentHuawei_to_huaweiChildFragment)

        }
        getTasks(preferencesStorage)
        adapter = FragmentHuaweiAdapter()
