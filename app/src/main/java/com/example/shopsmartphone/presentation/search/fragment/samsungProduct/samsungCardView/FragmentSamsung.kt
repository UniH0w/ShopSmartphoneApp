...
import com.example.shopsmartphone.databinding.FragmentSamsungBinding
...
class FragmentSamsung  : BaseFragment(){

    lateinit var binding: FragmentSamsungBinding
    lateinit var adapter: FragmentSamsungAdapter
    ...
    override fun onCreateView(
        ...
        binding.imageButton2.setOnClickListener {
            findNavController()
                .navigate(R.id.action_fragmentSamsung_to_samsungChildFragment)
        }


        getTasks(preferencesStorage)
        adapter = FragmentSamsungAdapter()
