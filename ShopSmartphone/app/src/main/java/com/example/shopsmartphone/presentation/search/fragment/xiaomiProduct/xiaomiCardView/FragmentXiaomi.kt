...
class FragmentXiaomi : BaseFragment() {
    lateinit var binding: FragmentXiaomiBinding
    lateinit var adapter: FragmentXiaomiAdapter
    ...
    override fun onCreateView(
        ...
        binding.imageButton2.setOnClickListener {
            findNavController()
                .navigate(R.id.action_fragmentXiaomi_to_xiaomiChildFragment)
        }


        getTasks(preferencesStorage)
        adapter = FragmentXiaomiAdapter()
        binding.recyclerViewCardView.adapter =adapter
        adapter.itemClick ={ CreateBasket()
