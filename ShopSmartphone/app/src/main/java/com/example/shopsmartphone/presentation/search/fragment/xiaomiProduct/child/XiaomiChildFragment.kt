...
class XiaomiChildFragment : BaseFragment() {
    private lateinit var binding: SamsungChildFragmentBinding
    private lateinit var adapter:XiaomiChildAdapter
    ...
    override fun onCreateView(
        ...
        binding.imageButton2.setOnClickListener {
            findNavController()
                .navigate(R.id.action_xiaomiChildFragment_to_fragmentSearch2)
        }
        ...
        adapter.itemClick = {
            ...
            findNavController()
                .navigate(R.id.action_xiaomiChildFragment_to_fragmentXiaomi, bundle)
        }
    ...
    private fun getProduct(preferencesStorage: PreferencesStorage) {
        ApiService.retrofit.getProduct(manufacturer = "Xiaomi","Bearer ${preferencesStorage.readLoginPreference()}").enqueue(
